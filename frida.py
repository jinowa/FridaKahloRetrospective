...
## Task 3
#It doesn't do much good to have the paintings without their dates, and vice versa. Zip together the two lists so that each painting is paired with 
#its date and resave it to the paintings variable. Make sure to convert the zipped object into a list 
#using the list() function. Print the results to the terminal to check your work.
